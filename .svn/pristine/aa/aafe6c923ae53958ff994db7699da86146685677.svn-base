...
.el-checkbox__inner{border-color:  #409eff;}
#thirdList .el-form{
  display: flex;
  width: 100%;
  flex-wrap: wrap;
...
#thirdList .el-form-item__label{line-height: normal!important;}
#thirdList .el-form-item{width:32%!important;display:flex;align-items: center;}
#thirdList .el-form-item__content{margin-left:0!important;width:60%!important;}
#thirdList .el-form-item2{width:100%!important;}
</style>
