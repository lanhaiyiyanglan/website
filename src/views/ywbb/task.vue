    ...
    goMap() {
      ...
      if (tableType == 'all') {
        if (tableLevel == '4') {
          ...
          if (valueFre == '4') {
            sessionStorage.setItem('pointFre', 4);
          } else {
            sessionStorage.setItem('pointFre', 'else');
          }
          sessionStorage.setItem('mapInfo', JSON.stringify(tableList4));
          sessionStorage.setItem('pointKey', this.valueDay);
        } else {
          window.vm.$message({
            type: 'error',
            message: '无空间位置',
        ...
        if (tableLevel == '3') {
          ...
          sessionStorage.setItem('mapInfo', JSON.stringify(tableList3));
          sessionStorage.setItem('pointKey', this.valueDay);
        } else {
          window.vm.$message({
            type: 'error',
        ...
        sessionStorage.setItem('mapInfo', JSON.stringify(tableList1));
        sessionStorage.setItem('pointKey', this.valueDay);
      } else {
        window.vm.$message({
          type: 'error',
