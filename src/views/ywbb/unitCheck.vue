    ...
    <div class="box">
        ...
        <div class="tableBox">
             <el-scrollbar style="height:100%;" class="spScollor">
                <div   id="tableExport">
                    <table class="ckTable" border="1" bordercolor="#c6c6c6">
                        <tr>
                            <td colspan="2">被考核单位：<input v-model="data.beAssCompany" class="spInput editInput" placeholder="点击输入"><span>{{data.beAssCompany}}</span></td> 
                            <td  colspan="2">考核部门:<input type="text" v-model="data.assDepartment" style="display:inline-block;width:80%;" placeholder="点击输入" class="editInput"><span>{{data.assDepartment}}</span></td> 
                            <td  colspan="2">考核人：<input type="text" v-model="data.assPerson" style="display:inline-block;width:80%;" placeholder="点击输入" class="editInput"><span>{{data.assPerson}}</span></td> 
                            <td  colspan="1">考核得分：<em style="color:#bd0008;font-style:normal;font-weight:bold;">{{data.score}}</em></td> 
                        </tr>
                        <tr>
                            <th width="8%">考核名称</th>
                            <th width="5%">子考核项目</th>
                        ...
                        <tr>
                            <td rowspan="9" style="text-align:center;">管道巡护和保卫管理(50分)</td>
                            ...
                            <td><input type="text" v-model="data.itemReason1" placeholder="点击输入" class="editInput"><span>{{data.itemReason1}}</span></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" v-model="data.itemReason2" placeholder="点击输入" class="editInput"><span>{{data.itemReason2}}</span></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" v-model="data.itemReason3" placeholder="点击输入" class="editInput"><span>{{data.itemReason3}}</span></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" v-model="data.itemReason4" placeholder="点击输入" class="editInput"><span>{{data.itemReason4}}</span></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" v-model="data.itemReason5" placeholder="点击输入" class="editInput"><span>{{data.itemReason5}}</span></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" v-model="data.itemReason6" placeholder="点击输入" class="editInput"><span>{{data.itemReason6}}</span></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" v-model="data.itemReason7" placeholder="点击输入" class="editInput"><span>{{data.itemReason7}}</span></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" v-model="data.itemReason8" placeholder="点击输入" class="editInput"><span>{{data.itemReason8}}</span></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" v-model="data.itemReason9" placeholder="点击输入" class="editInput"><span>{{data.itemReason9}}</span></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" v-model="data.itemReason10" placeholder="点击输入" class="editInput"><span>{{data.itemReason10}}</span></td>
                        </tr>
                        <tr>
                            <td style="text-align:center;">2</td>
                            ...
                            <td><input type="text" v-model="data.itemReason11" placeholder="点击输入" class="editInput"><span>{{data.itemReason11}}</span></td>
                        </tr>
                        <tr>
                            <td style="text-align:center;">3</td>
                            ...
                            <td><input type="text" v-model="data.itemReason12" placeholder="点击输入" class="editInput"><span>{{data.itemReason12}}</span></td>
                        </tr>
                        <tr>
                            <td style="text-align:center;">4</td>
                            ...
                            <td><input type="text" v-model="data.itemReason13" placeholder="点击输入" class="editInput"><span>{{data.itemReason13}}</span></td>
                        </tr>
                        <tr>
                            <td style="text-align:center;">5</td>
                            ...
                            <td><input type="text" v-model="data.itemReason14" placeholder="点击输入" class="editInput"><span>{{data.itemReason14}}</span></td>
                        </tr>
                        <tr>
                            <td style="text-align:center;">6</td>
                            ...
                            <td><input type="text" v-model="data.itemReason15" placeholder="点击输入" class="editInput"><span>{{data.itemReason15}}</span></td>
                        </tr>
                        <tr>
                            <td rowspan="3">7</td>
                            ...
                            <td>每缺一项扣1分。</td>
                            <td rowspan="2"></td>
                            <td rowspan="3"><input type="number" v-model="data.item16" @blur="changeScore()" placeholder="点击输入" class="editInput" @input="setValue($event.target,'item16')"><span>{{data.item16}}</span></td>
                            <td rowspan="3"><input type="text" v-model="data.itemReason16" placeholder="点击输入" class="editInput"><span>{{data.itemReason16}}</span></td>
                        </tr>
                        <tr>
                            <td style="text-align:left;">督促施工方进行地貌恢复和场地平整。</td>
                            <td>现场一项不符合要求，扣1分。</td>
                        </tr>
                        <tr>
                            <td style="text-align:left;">配合公司、分公司及外部支持人员开展现场问题排查。</td>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="text-align:left;">1.发生打孔盗油案件，1次扣20分</td>
                            <td rowspan="5"><input type="number" v-model="data.other" @blur="changeScore()" placeholder="点击输入" class="editInput" @input="setValue($event.target,'other')"><span>{{data.other}}</span></td>
                            <td rowspan="5"><input type="text" v-model="data.otherReason" placeholder="点击输入" class="editInput"><span>{{data.otherReason}}</span></td>
                        </tr>
                        <tr>
                            <td colspan="3" style="text-align:left;">2.发生由施工方造成的管道损坏事故，1次扣20分；</td>
                        </tr>
                        <tr>
                            <td colspan="3" style="text-align:left;">3.新增违章占压，发生1起扣10分；</td>
                        </tr>
                        <tr>
                            <td colspan="3" style="text-align:left;">4. 发生腐蚀穿孔，一次扣20分；</td>
                        </tr>
                        <tr>
                            <td colspan="3" style="text-align:left;">4.光缆中断（非自然中断），发生1起（单点）扣10分。</td>
                        </tr>
                        <tr>
                            <td>总分</td>
                            <td colspan="6" style="font-weight:bold;"><em style="color:#bd0008;font-style:normal;">{{data.score}}</em></td>
                        </tr>
                    </table>
                </div>
...
.tableBox tr td:first-child{text-align: center;}
.tableBox tr:first-child td:first-child{text-align:left;}
