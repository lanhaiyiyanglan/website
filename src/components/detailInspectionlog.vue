      ...
      <div class="formbox">
        ...
        >
          ...
          <el-form-item label="巡线员：" prop="userId">
            ...
            <template v-if='form.gpsInspectionLog.userName!=null&&form.gpsInspectionLog.userName!=""'>
              {{form.gpsInspectionLog.userName}}
            </template>
            <template v-else>
              {{userName}}
            </template>
...
export default {
  ...
  methods:{
   ...
   getPerson(e){
     ...
     this.$myHttp.get('gpsGroups/getPersonList?userId=' +this.$Cookie.get('userId')+'&areaId='+this.form.gpsInspectionLog.pgroupCode+'&stationId='+e+'&clientType='+clientType).then((res) => {
     ...
     this.$refs[formName].validate((valid) => {
        if (valid) {
            ...
            let obj={
              ...
              "userId":(this.form.gpsInspectionLog.userId==null||this.form.gpsInspectionLog.userId=="")?this.$Cookie.get('userId'):this.form.gpsInspectionLog.userId,
              "userName":(this.form.gpsInspectionLog.userName==null||this.form.gpsInspectionLog.userName=="")?this.$Cookie.get('userName'):this.form.gpsInspectionLog.userName,
              "reviewComment":this.form.gpsInspectionLog.reviewComment
              //"reviewComment":this.$Cookie.get('userId')
            }
            this.$emit('sub',obj);
        }
     })
